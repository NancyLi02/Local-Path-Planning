...
silently overlapping in the published page.
    ...
    python -m step_e_v1.report_diagrams        # writes /tmp/diagrams.json
"""
...
# ------------------------------------------------------------------- rail V0
def rail():
    f = Fig(VW, 300, "Rail V0: AMRs are ordered by time to collision, a four-step speed "
...
# ------------------------------------------------------------------------ V1
def v1():
    f = Fig(VW, 336, "V1 safety-first: a conflict cluster is encoded per AMR, an attention "
...
if __name__ == "__main__":
    import json, pathlib
    out = {"stopgo": stopgo(), "rail": rail(), "v1": v1()}
