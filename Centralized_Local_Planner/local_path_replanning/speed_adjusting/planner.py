"""speed adjusting -- TTC-priority sequential replanning with a space-time shield.
...
from ...tools.geometry import point_in_polygon
from ...tools.affected_amr import AMR, ConflictResult
...
class SpeedAdjustingReplanner:
    """TTC-priority sequential replanner + space-time reservation shield."""

    def __init__(self, cfg: SpeedAdjustingConfig | None = None):
        self.cfg = cfg or SpeedAdjustingConfig()
