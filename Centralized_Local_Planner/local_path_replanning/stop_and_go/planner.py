...
The classic industrial AMR safety controller. It keeps the whole local-replanning
...
so it has
    ...
    * no speed modulation   (the speed factors are gone),
...
Comparing it against speed adjusting isolates exactly what continuous speed control plus the
lateral degree of freedom are worth, and comparing it against the learned planner shows what the
